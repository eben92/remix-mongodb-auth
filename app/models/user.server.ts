...
// userSchema.static('getUserById', async function (_id: string) {
//   if (!_id) throw Error('No id');

//   const user: any = await this.findById(_id).select(
//     '-password -__v -refresh_token'
//   );
...
const UserModel1 = (module.exports =
  models.User || model<IUser, UserModel>('User', userSchema));

// const User: any = (module.exports = models.User || UserModel1());

export async function getPosts() {
  const posts = await UserModel1.find();
  // return posts;
